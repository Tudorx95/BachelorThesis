...
Cele mai populare atacuri raportate la scara globala pentru anul curent 2025 sunt ransomware (conform \footnote{\fullcite{dnsc_buletin_2025}}, in SUA s-au raportat cresteri
...
Pentru a limita utilizarea abuzivă a tehnologiilor bazate pe AI, Uniunea Europeană a adoptat în 2024 un set de reglementări stricte privind integrarea acestor module în aplicațiile software, prin AI Act \footnote{\fullcite{eu_ai_act_overview_2024}}.
...
precum otravirea datelor (data poisoning) amintite anterior \footnote{\fullcite{ibmfl_api}}. Unele dintre aceste framework-uri sunt poate dificil de gestionat si configurat \footnote{\fullcite{ibmfl_github}}, si nu permit extinderea usoara prin integrare altor componente.
...
Diferenta dintre aceste doua concepte este in modul in care acesti algoritmi invata si procentul de utilizare a datelor \footnote{\fullcite{ibm_ai_vs_ml_dl}}.
...
\begin{figure}[h!]
    ...
    \caption{Arhitectura interna a unui dispozitiv   \footnote{\fullcite{bonawitz2019towards}}}
...
\begin{figure}[h!]
    ...
    \caption{Procedee in invatare automata federata \footnote{\fullcite{bonawitz2019towards}}}    
    \label{fig:nume-label}
\end{figure}
...
Platforma sprijina analistii de securitate si cercetatorii de analiza de date in vederea constientizarii unei posibile vulnerabilitati la nivelul unei infrastructuri publice centralizate.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item \textbf{poison\_intensity}: intensitatea atacului (ex: 0.1 pentru zgomot Gaussian, dimensiune trigger pentru backdoor)
        ...
        Rezultatele sunt salvate în trei fișiere: \texttt{analysis.json} (metrici structurate), \texttt{summary.txt} (rezumat text asupra simularilor) și \texttt{attack\_info.json} (detalii atac).
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=1.5\textwidth]{../images/Arhitectura_Aplicatie.png}
